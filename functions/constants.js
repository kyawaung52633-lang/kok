...
// Bot Token (env ကနေယူမယ်)
export const BOT_TOKEN = "8821073289:AAF-eVtEceQd7o60Akv-eW36iK5vd855ozE";
export const ADMIN_ID = 6300369636;

// SNI List
export const SNI_LIST = [
    "speedd5.onvip.my.id",
    "kokgsever.kokplus.web.id",
    "",
    ""
];
